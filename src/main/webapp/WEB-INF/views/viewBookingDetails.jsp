...
<body  style="background-color: Turquoise;">
	<table border="1">
		...
		<td><c:url var="url" value="/cancelReservation">
						<c:param name="reservationNumber" value="${reserve.reservationNumber}" />
					</c:url> <a href="${url}">Cancel Reservation</a></td>
					<td><c:url var="url" value="/getReceipt">
						<c:param name="reservationNumber" value="${reserve.reservationNumber}" />
					</c:url> <a href="${url}">Get Receipt</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
